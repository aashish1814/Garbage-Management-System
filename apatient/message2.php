...
include 'aside.php'; ?>
 <script>
  ...
  <?php 
                            $sq=mysqli_query($con,"SELECT * FROM msgs WHERE mrecep='".$_SESSION['username']."' ");
                            ?>
 ...
 <?php $k=1;  $rpls=0;
                                ...
                                $realSender=mysqli_fetch_array(mysqli_query($con,"SELECT fullname FROM ulogin WHERE username='".$hk['mrecep']."'"));
                                $realSende=mysqli_fetch_array(mysqli_query($con,"SELECT ucat FROM ulogin WHERE username='".$hk['mrecep']."'"));
                                $realSend=mysqli_fetch_array(mysqli_query($con,"SELECT ucat FROM ulogin WHERE username='".$hk['msender']."'"));
                                    ...
                                    <tr>
                                        <th scope="row"><?php echo $k;?></th>
                                         <td><?php echo $rdate;?></td> 
                                            ...
                                            <td><?php echo ucfirst($hk['msender']);?>-<?php echo ucfirst($realSend['ucat']);?></td> 
