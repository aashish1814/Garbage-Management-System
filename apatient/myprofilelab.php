...
<hr>
        ...
        <?php 
                           $e=$_SESSION['username'];
                            ...
                            $sq=mysqli_query($con,"SELECT * FROM newlab WHERE cname='$e' AND name='Pending' AND pstatus='Pending'");
...
<th>Accept Invoice By Cash</th>   <th>Accept Invoice By E-Wallet</th>   
 ...
 <td><a href="preview222lab.php?invoice=<?php echo $hk['invoice'];?>">View Invoice</a></td>
                                          
 <td><a href="acclabeditviewinvoice.php?transaction_id=<?php echo $hk['transaction_id']?>&invoice=<?php echo $hk['invoice']?>&date=<?php echo $hk['date']; ?>&cashier=<?php echo $hk['cashier']?>&type=<?php echo $hk['type']?>&fileNo=<?php echo $hk['fileNo'];?>&cname=<?php echo $hk['cname'];?>&name=<?php echo $hk['name'];?>&amount=<?php echo $hk['amount'];?>&pstatus=<?php echo $hk['pstatus'];?>&primary_doc=<?php echo $hk['primary_doc'];?>&patientname=<?php echo $hk['patientname'];?>">Accept To Pay By Cash</a></td>

   
                                        
  <td><a href="acclabeditviewinvoice2.php?transaction_id=<?php echo $hk['transaction_id']?>&invoice=<?php echo $hk['invoice']?>&date=<?php echo $hk['date']; ?>&cashier=<?php echo $hk['cashier']?>&type=<?php echo $hk['type']?>&fileNo=<?php echo $hk['fileNo'];?>&cname=<?php echo $hk['cname'];?>&name=<?php echo $hk['name'];?>&amount=<?php echo $hk['amount'];?>&pstatus=<?php echo $hk['pstatus'];?>&primary_doc=<?php echo $hk['primary_doc'];?>&patientname=<?php echo $hk['patientname'];?>">Accept Invoice By E-Wallet</a></td>
