...
<hr>
         ...
         <?php 
                           $e=$_SESSION['username'];
                            ...
                            $sq=mysqli_query($con,"SELECT * FROM newdrug WHERE cname='$e' AND name='Accepted' AND pstatus='Pending'");
                                    ...
                                    <tr>
                                        <th scope="col">No</th>
                                         <th>Invoice No</th>
                                            ...
                                            <th>Drugs</th><th>View</th>
<th>Accept By Cash</th>    </tr>
                                    </thead>
                                     <tbody>
                                    <?php $k=1;  
                             ...
                             <td><?php echo $hk['primary_doc'];?></td>
                                            <td><a href="preview222treat.php?invoice=<?php echo $hk['invoice'];?>">View Invoice</a></td> <td><a href="acclabeditviewinvoicea.php?transaction_id=<?php echo $hk['transaction_id']?>&invoice=<?php echo $hk['invoice']?>&date=<?php echo $hk['date']; ?>&cashier=<?php echo $hk['cashier']?>&type=<?php echo $hk['type']?>&fileNo=<?php echo $hk['fileNo'];?>&cname=<?php echo $hk['cname'];?>&name=<?php echo $hk['name'];?>&amount=<?php echo $hk['amount'];?>&pstatus=<?php echo $hk['pstatus'];?>&primary_doc=<?php echo $hk['primary_doc'];?>">Accept Invoice By Cash</a></td>
