...
<hr>
        ...
        <nav aria-label="breadcrumb">
                                ...
                                <!--   <li class="breadcrumb-item"><a href="patientinvoices.php?user=<?php echo $_SESSION['username']; ?>" class="text-muted">Pending Lab Payments</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            $sq=mysqli_query($con,"SELECT * FROM newlab WHERE cname='$id' AND pstatus='Paid' ");
                            ?>
                  ...
                  <div class="col-12">
                        <div class="card">
                           ...
                           <?php 
                            ...
                            $sq=mysqli_query($con,"SELECT * FROM newdrug WHERE cname='$id' AND pstatus='Paid' ");
                            ?>
                           <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                  ...
                  <div class="col-12">
                        <div class="card">
                           ...
                           <?php 
                            ...
                            $sq=mysqli_query($con,"SELECT * FROM newscan WHERE cname='$id' AND pstatus='Paid' ");
                            ?>
                           <div class="table-responsive">
                                    <table class="table">
                                        <thead>
